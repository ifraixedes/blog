...
This post is part of series of posts about installing  and configuring [Arch Linux](https://archlinux.org/) in a [Slimbook](https://slimbook.com/en/) Executive 14". They are created from a collection of personal notes, that I thought that may be some useful for others, so I published them through these series.
